...
func (o *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewMatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 422:
		result := NewMatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewMatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK() *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK {
	return &MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK{}
}
...
func (o *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK) Error() string {
	return fmt.Sprintf("[POST /infinite_image_browsing/db/match_images_by_tags][%d] matchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK  %+v", 200, o.Payload)
}
...
func (o *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity() *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity {
	return &MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity{}
}
...
func (o *MatchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /infinite_image_browsing/db/match_images_by_tags][%d] matchImageByTagsInfiniteImageBrowsingDbMatchImagesByTagsPostUnprocessableEntity  %+v", 422, o.Payload)
}
