...
func (o *VersionControlnetVersionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewVersionControlnetVersionGetOK()
...
func NewVersionControlnetVersionGetOK() *VersionControlnetVersionGetOK {
	return &VersionControlnetVersionGetOK{}
}
...
func (o *VersionControlnetVersionGetOK) Error() string {
	return fmt.Sprintf("[GET /controlnet/version][%d] versionControlnetVersionGetOK  %+v", 200, o.Payload)
}
...
func (o *VersionControlnetVersionGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
