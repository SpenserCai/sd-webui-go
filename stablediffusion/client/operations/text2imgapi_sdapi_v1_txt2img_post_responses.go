...
func (o *Text2imgapiSdapiV1Txt2imgPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 500:
		result := NewText2imgapiSdapiV1Txt2imgPostInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewText2imgapiSdapiV1Txt2imgPostInternalServerError() *Text2imgapiSdapiV1Txt2imgPostInternalServerError {
	return &Text2imgapiSdapiV1Txt2imgPostInternalServerError{}
}
...
func (o *Text2imgapiSdapiV1Txt2imgPostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /sdapi/v1/txt2img][%d] text2imgapiSdapiV1Txt2imgPostInternalServerError  %+v", 500, o.Payload)
}
...
func (o *Text2imgapiSdapiV1Txt2imgPostInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
