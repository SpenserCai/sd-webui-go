...
func (o *SkipSdapiV1SkipPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSkipSdapiV1SkipPostOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewSkipSdapiV1SkipPostInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *SkipSdapiV1SkipPostOK) Error() string {
	return fmt.Sprintf("[POST /sdapi/v1/skip][%d] skipSdapiV1SkipPostOK  %+v", 200, o.Payload)
}
...
func (o *SkipSdapiV1SkipPostOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewSkipSdapiV1SkipPostInternalServerError() *SkipSdapiV1SkipPostInternalServerError {
	return &SkipSdapiV1SkipPostInternalServerError{}
}
...
func (o *SkipSdapiV1SkipPostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /sdapi/v1/skip][%d] skipSdapiV1SkipPostInternalServerError  %+v", 500, o.Payload)
}
...
func (o *SkipSdapiV1SkipPostInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
