...
func (o *GetTokenTokenGetOK) Error() string {
	return fmt.Sprintf("[GET /token][%d] getTokenTokenGetOK  %+v", 200, o.Payload)
}
...
func (o *GetTokenTokenGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
