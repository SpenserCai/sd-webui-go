...
// NewPredictOcrPredictPostParams creates a new PredictOcrPredictPostParams object,
...
func NewPredictOcrPredictPostParams() *PredictOcrPredictPostParams {
	return &PredictOcrPredictPostParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPredictOcrPredictPostParamsWithTimeout creates a new PredictOcrPredictPostParams object
...
// NewPredictOcrPredictPostParamsWithContext creates a new PredictOcrPredictPostParams object
...
// NewPredictOcrPredictPostParamsWithHTTPClient creates a new PredictOcrPredictPostParams object
...
PredictOcrPredictPostParams contains all the parameters to send to the API endpoint
	...
	for the predict ocr predict post operation.

	Typically these are written to a http.Request.
*/
type PredictOcrPredictPostParams struct {

	// Body.
	Body *models.OcrPredictRequest
