...
func (o *APISetSendImgPathInfiniteImageBrowsingSendImgPathPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 500:
		result := NewAPISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewAPISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError() *APISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError {
	return &APISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError{}
}
...
func (o *APISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /infinite_image_browsing/send_img_path][%d] apiSetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError  %+v", 500, o.Payload)
}
...
func (o *APISetSendImgPathInfiniteImageBrowsingSendImgPathPostInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
