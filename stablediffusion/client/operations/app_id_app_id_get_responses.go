...
func (o *AppIDAppIDGetOK) Error() string {
	return fmt.Sprintf("[GET /app_id][%d] appIdAppIdGetOK  %+v", 200, o.Payload)
}
...
func (o *AppIDAppIDGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
