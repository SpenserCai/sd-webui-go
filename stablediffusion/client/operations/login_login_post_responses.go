...
func (o *LoginLoginPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 500:
		result := NewLoginLoginPostInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewLoginLoginPostInternalServerError() *LoginLoginPostInternalServerError {
	return &LoginLoginPostInternalServerError{}
}
...
func (o *LoginLoginPostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /login][%d] loginLoginPostInternalServerError  %+v", 500, o.Payload)
}
...
func (o *LoginLoginPostInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
