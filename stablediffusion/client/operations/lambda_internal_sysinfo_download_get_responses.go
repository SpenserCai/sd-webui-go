...
func (o *LambdaInternalSysinfoDownloadGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLambdaInternalSysinfoDownloadGetOK()
...
func NewLambdaInternalSysinfoDownloadGetOK() *LambdaInternalSysinfoDownloadGetOK {
	return &LambdaInternalSysinfoDownloadGetOK{}
}
...
func (o *LambdaInternalSysinfoDownloadGetOK) Error() string {
	return fmt.Sprintf("[GET /internal/sysinfo-download][%d] lambdaInternalSysinfoDownloadGetOK  %+v", 200, o.Payload)
}
...
func (o *LambdaInternalSysinfoDownloadGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
