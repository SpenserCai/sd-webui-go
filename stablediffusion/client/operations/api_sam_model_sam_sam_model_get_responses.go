...
func (o *APISamModelSamSamModelGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewAPISamModelSamSamModelGetOK()
...
func NewAPISamModelSamSamModelGetOK() *APISamModelSamSamModelGetOK {
	return &APISamModelSamSamModelGetOK{}
}
...
func (o *APISamModelSamSamModelGetOK) Error() string {
	return fmt.Sprintf("[GET /sam/sam-model][%d] apiSamModelSamSamModelGetOK  %+v", 200, o.Payload)
}
...
func (o *APISamModelSamSamModelGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
