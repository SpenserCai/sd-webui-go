...
func (o *CreateFoldersInfiniteImageBrowsingMkdirsPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 500:
		result := NewCreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError() *CreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError {
	return &CreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError{}
}
...
func (o *CreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /infinite_image_browsing/mkdirs][%d] createFoldersInfiniteImageBrowsingMkdirsPostInternalServerError  %+v", 500, o.Payload)
}
...
func (o *CreateFoldersInfiniteImageBrowsingMkdirsPostInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
