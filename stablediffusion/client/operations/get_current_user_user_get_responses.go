...
func (o *GetCurrentUserUserGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCurrentUserUserGetOK()
...
func NewGetCurrentUserUserGetOK() *GetCurrentUserUserGetOK {
	return &GetCurrentUserUserGetOK{}
}
...
func (o *GetCurrentUserUserGetOK) Error() string {
	return fmt.Sprintf("[GET /user][%d] getCurrentUserUserGetOK  %+v", 200, o.Payload)
}
...
func (o *GetCurrentUserUserGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
